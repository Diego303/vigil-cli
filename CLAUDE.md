...
- **FASE 0** (DONE): Scaffolding, config, core engine, CLI, formatters, rule catalog — 125 tests
- **FASE 1**: DependencyAnalyzer (parsers, registry client, similarity/typosquatting, popular packages corpus)
